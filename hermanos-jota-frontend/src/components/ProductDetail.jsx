...
import { productos as productosDetalle } from "../productosDetalle"; // importar productos
import "../CSS/Detalle.css";

function DetalleProducto({ producto, onBack, onAddToCart }) {
  ...
  const enviarWhatsApp = () => {
    const telefono = "5491122334455"; // tu número
